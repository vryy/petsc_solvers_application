...
class PetscFieldSplit_U_Nested_Subdomains_WP_Solver : public LinearSolver<TSparseSpaceType, TDenseSpaceType, TModelPartType>
{
public:
     ...
     * Destructor
     */
    ~PetscFieldSplit_U_Nested_Subdomains_WP_Solver() override
    {
    }
