...
class PetscFieldSplit_U_Subdomains_Solver : public LinearSolver<TSparseSpaceType, TDenseSpaceType, TModelPartType>
{
public:
     ...
     * Destructor
     */
    ~PetscFieldSplit_U_Subdomains_Solver() override
    {
    }
