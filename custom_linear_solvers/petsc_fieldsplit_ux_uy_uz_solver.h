...
class PetscFieldSplit_UX_UY_UZ_Solver : public LinearSolver<TSparseSpaceType, TDenseSpaceType, TModelPartType>
{
public:
     ...
     * Default Constructor
     */
    PetscFieldSplit_UX_UY_UZ_Solver()
     ...
     * Destructor
     */
    ~PetscFieldSplit_UX_UY_UZ_Solver() override
    {
    }
