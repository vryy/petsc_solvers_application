...
class PetscFieldSplit_UX_UY_UZ_Shield_Solver : public LinearSolver<TSparseSpaceType, TDenseSpaceType, TModelPartType>
{
public:
     ...
     * Default Constructor
     */
    PetscFieldSplit_UX_UY_UZ_Shield_Solver(boost::python::list& shield_nodes)
     ...
     * Destructor
     */
    ~PetscFieldSplit_UX_UY_UZ_Shield_Solver() override
    {
    }
