...
class PetscFieldSplit_V_P_Solver : public LinearSolver<TSparseSpaceType, TDenseSpaceType, TModelPartType>
{
public:
     ...
     * Default Constructor
     */
    PetscFieldSplit_V_P_Solver()
    : BaseType(), m_my_rank(0), m_is_block(true), mblocksize_v(3)
    {
    }

    PetscFieldSplit_V_P_Solver(bool is_block, int blocksize_v)
    : BaseType(), m_my_rank(0), m_is_block(is_block), mblocksize_v(blocksize_v)
    {
    }
     ...
     * Destructor
     */
    ~PetscFieldSplit_V_P_Solver() override
    {
    }
